...
#### NPM
https://www.npmjs.com/package/sequin-wallet-backend-js

#### Github

https://github.com/sequin/sequin-wallet-backend-js

# Sequin-wallet-backend

Provides an interface to the Sequin network, allowing wallet applications to be built.
...
`npm install sequin-wallet-backend-js --save`

Yarn:

`yarn add sequin-wallet-backend-js`

## Documentation

[You can view the documentation here](https://github.com/sequin/sequin-wallet-backend-js/blob/master/docs/classes/_walletbackend_.walletbackend.html)

You can see a list of all the other classes on the right side of the screen.
Note that you will need to prefix them all with `WB.` to access them, if you are not using typescript style imports, assuming you imported with `const WB = require('sequin-wallet-backend-js')`.


### Javascript

```javascript
const WB = require('sequin-wallet-backend-js');
...
```typescript
import { WalletBackend, Daemon, IDaemon } from 'sequin-wallet-backend-js';
